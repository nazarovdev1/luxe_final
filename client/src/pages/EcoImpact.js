  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex justify-between items-end">
        <span className="text-[12px] uppercase tracking-[0.3em] text-gray-400 font-black">Ekologik Reiting</span>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-20">
          <div className="inline-flex items-center gap-2.5 bg-gradient-to-r from-green-600/20 via-green-600/10 to-transparent border-l-2 border-green-600 px-6 py-2 mb-8">
            ...
            <span className="text-green-500 text-[10px] tracking-[0.4em] uppercase font-black">Barqaror Kelajak</span>
          </div>
          ...
          <p className="text-gray-400 text-lg md:text-xl font-light max-w-3xl leading-relaxed">
            Har bir ongli xaridingiz tabiatga ijobiy ta'sir ko'rsatadi. Bu yerda siz o'z hissangizni <span className="text-white font-medium italic underline decoration-green-600/40 underline-offset-4">real vaqtda</span> va shaffof ko'rishingiz mumkin.
          </p>
        </div>
        ...
        {!isAuthenticated ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 gap-6">
            ...
            <p className="text-green-500 text-sm tracking-widest font-medium animate-pulse">Ma'lumotlar tahlil qilinmoqda...</p>
          </div>
        ) : stats ? (
          <div className="space-y-24">
            ...
            <div className="flex flex-col items-center">
              <div className="relative group">
                ...
                <div className="relative flex items-center gap-8 bg-gradient-to-br from-white/[0.05] to-transparent border border-white/10 px-12 py-8 rounded-[40px] backdrop-blur-xl">
                  ...
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.3em] text-gray-400 font-black mb-2">Eco Darajangiz</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="rounded-[40px] border border-white/5 bg-white/[0.02] p-10 md:p-12 relative overflow-hidden group">
                ...
                <h2 className="text-xl font-serif mb-10 text-white">O'rtacha Ball</h2>
                <EcoScoreBar score={stats.avgEcoScore} />
              ...
              {stats.topCategories?.length > 0 && (
                <div className="rounded-[40px] border border-white/5 bg-white/[0.02] p-10 md:p-12">
                  <h2 className="text-2xl font-serif mb-10 flex items-center gap-4 text-white">
                    <BarChart3 className="w-6 h-6 text-[#d6b47c]" /> Top Yo'nalishlar
                  </h2>
            ...
            <div>
              <div className="flex items-center gap-6 mb-16">
                ...
                <h2 className="text-[10px] uppercase tracking-[0.5em] text-gray-500 font-black">Eco Maslahatlar</h2>
                <div className="h-px flex-1 bg-gradient-to-r from-transparent via-green-600/20 to-transparent" />
              </div>
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-xl text-gray-500">Hali xaridlar yo'q</h3>
